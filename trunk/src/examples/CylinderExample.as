package examples 
{
	...
	import de.nulldesign.nd3d.objects.Cylinder;
	 ...
	 * 2009/06/04
	 */
	public class CylinderExample extends AbstractView
	{
		private var s1:Cylinder;
		private var s2:Cylinder;
		private var s3:Cylinder;
		...
		public function CylinderExample() 
		{
			...
			s1 = new Cylinder([ma, ma, ma], 50, new Vertex(0, 0, 0), 200, 5, 3);
			renderList.push(s1); 
						 
			var mat:LineMaterial = new LineMaterial(0x00ff00);
			s2 = new Cylinder([mat, mat, mat], 50, new Vertex(110, 0, 0), 200, 5, 3);
			renderList.push(s2); 
			...
			s3 = new Cylinder([mat1,mat1,mat1], 50, new Vertex(220, 10, 0), 200, 5, 3);
			renderList.push(s3); 
