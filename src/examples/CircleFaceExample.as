package examples 
{
	...
	import de.nulldesign.nd3d.objects.CircleFace;
	 ...
	 * 2009/06/04
	 */
	public class CircleFaceExample extends AbstractView
	{
		private var s1:CircleFace;
		private var s2:CircleFace;
		private var s3:CircleFace;

		[Embed("assets/doggy.jpg")]
		private var MyTexture:Class;    

		public function CircleFaceExample() 
		{
			super(600, 400);
                         
			var ma:PixelMaterial = new PixelMaterial(0x000000);
			s1 = new CircleFace(ma, 100, new Vertex(10, 10, 100), 10, 1);
			renderList.push(s1); 
						 
			var mat:LineMaterial = new LineMaterial(0x000000);
			s2 = new CircleFace(mat, 100, new Vertex(10, 10, 50), 10, 1);
			renderList.push(s2); 
			...
			s3 = new CircleFace(mat1, 100, new Vertex(10, 10, 10), 10, 1);
			renderList.push(s3); 
